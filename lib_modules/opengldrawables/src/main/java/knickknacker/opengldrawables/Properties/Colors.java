package knickknacker.opengldrawables.Properties;
...
public abstract class Colors {
    ...
    public final static float[] GREEN = {0.0f, 1.0f, 0.0f, 1.0f};
    ...
    public final static float[] YELLOW = {1.0f, 1.0f, 0.0f, 1.0f};
    ...
    public final static float[] YELLOW_ALPHA_6 = {1.0f, 1.0f, 0.0f, 0.6f};
