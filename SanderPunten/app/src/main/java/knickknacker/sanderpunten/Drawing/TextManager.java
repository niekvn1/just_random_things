...
import knickknacker.sanderpunten.Drawing.Tools.Textures;
...
public class TextManager {
    ...
    public boolean load(String file, int size, float padX, float padY) {
        fontPadX = padX;
        fontPadY = padY;
    ...
    private void insertData(float[] points, float[] texels, int i, float letterX, float letterY,
        ...
        points[i * 6 * 2 + 1] = letterY;
        points[i * 6 * 2 + 2] = letterX;
        points[i * 6 * 2 + 3] = letterY + chrHeight;
        points[i * 6 * 2 + 4] = letterX + chrWidth;
        points[i * 6 * 2 + 5] = letterY;
        points[i * 6 * 2 + 6] = letterX + chrWidth;
        points[i * 6 * 2 + 7] = letterY + chrHeight;
        points[i * 6 * 2 + 8] = letterX;
        points[i * 6 * 2 + 9] = letterY + chrHeight;
        points[i * 6 * 2 + 10] = letterX + chrWidth;
        points[i * 6 * 2 + 11] = letterY;
